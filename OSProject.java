...
public class OSProject {
    ...
    String[] choices = { " Select An Algorithm ", " First Come First Serve ", " Shortest Job First (Preemptive) ",
    ...
    public OSProject() {
        ...
        solveButton.addActionListener(e -> {
            ...
            if (choice == 0) {
                JOptionPane.showMessageDialog(mainFrame, "Please Select Valid Algorithm",
            ...
            if (arrivalTimes.length != burstTimes.length) {
                JOptionPane.showMessageDialog(mainFrame, "Please Enter Equal Number of Arrival Time and Burst Time",
                        "Alert", JOptionPane.ERROR_MESSAGE);
